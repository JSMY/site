...
Meetup.add({
	...
	place: { type: String, required: false, initial: true, width: 'medium', default: 'Level 3, Wisma Yeap Chor Ee', note: 'Level 3, Wisma Yeap Chor Ee' },
	map: { type: String, required: false, initial: true, width: 'medium', default: 'Wisma Yeap Chor Ee, Penang', note: 'Wisma Yeap Chor Ee, Penang' },
